//Note: Again, students are not required to understand the implementation of this class,
...
public class AVLTreePrinter {
    ...
    public AVLTreePrinter(AVLTree<Integer> t) {
        tree = t;
    }

    public void print() {

        ArrayList<AVLTree<Integer>.AVLNode<Integer>> thisLevelNodes = new ArrayList<>(); 
    ...
    private void printData(int level, int offset, ArrayList<AVLTree<Integer>.AVLNode<Integer>> levelNodes) {
        printSpaces(offset);

        int k = POWERS_OF_2[level];
        for (int i = 0; i < k; i++) {
            AVLTree<Integer>.AVLNode<Integer> p = levelNodes.get(i);
    ...
    private void printOutgoingLinks(int level, int offset, ArrayList<AVLTree<Integer>.AVLNode<Integer>> levelNodes) {
        printSpaces(offset);
    ...
    public void printConnectingDashes(int level, int offset, ArrayList<AVLTree<Integer>.AVLNode<Integer>> levelNodes) {
        if (offset > 1) {
            printSpaces(offset);
        }
    ...
    private void printIncomingLinks(int level, int offset, ArrayList<AVLTree<Integer>.AVLNode<Integer>> levelNodes) {
        printSpaces(offset);
    ...
    private ArrayList<AVLTree<Integer>.AVLNode<Integer>> getNextLevelNodes(int level, ArrayList<AVLTree<Integer>.AVLNode<Integer>> levelNodes) {
        int size = POWERS_OF_2[level];
        ArrayList<AVLTree<Integer>.AVLNode<Integer>> nextLevelNodes = new ArrayList<>();//BinaryNode *next_level[size];
